...
```{r summary sentences}
paste("The most common ad I have encountered while I watched YouTube is", max(latest_data$Type_of_YouTube_Advertisement), "ads.")

paste("The total amount of ads I have collected data on is", length(latest_data$Rating), "ads.")

paste("The longest ad I have encountered was in", max(latest_data$Time_Span_in_Seconds), "seconds. Hence, we can see the huge outlier for the Length of YT Ads barplot.")

paste("Collectively, all my", length(latest_data$Rating), "observed ads should have lasted", sum(latest_data$Time_Span_in_Seconds), "seconds if I watched all of those ads in full in total.")
```
```{r barplots}
latest_data %>%
  ggplot() + 
